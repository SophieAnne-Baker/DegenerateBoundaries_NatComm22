function [r, r_std, v, v_std] = rewardScaledOscil(x, dist, wcs, nsamples, itrial)
% x = thresholds
% wcs = cost parameters
...
if length(x)==1; x(2) = eps; x(3) = eps; end
...
for isample = 1:nsamples
    sc = scale( exp( dist.z( 2:end, :, itrial(isample) ) ), x(2), x(3) );
